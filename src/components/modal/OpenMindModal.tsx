      ...
      content={
        <div className="flex h-full w-full flex-col space-y-6 p-4 md:space-y-12">
          ...
          <div className="flex flex-col gap-12">
            <h1 className="sm:text-2xl text-xl font-bold md:text-3xl">오픈 마인드</h1>
            <table className="min-w-full divide-y divide-none">
              <tbody className="divide-y divide-none">
                <tr>
                  <th className="p-2 text-left text-sm text-text-secondary md:text-xl">
                    프로젝트 제목
                  </th>
                  <td className="p-2 text-left text-sm md:text-xl">오픈마인드</td>
                </tr>
                <tr>
                  <th className="p-2 text-left text-sm text-text-secondary md:text-xl">
                    진행 기간
                  </th>
                  <td className="p-2 text-left text-sm md:text-xl">24.04.30 ~ 24.05.17</td>
                </tr>
                <tr>
                  <th className="p-2 text-left text-sm text-text-secondary md:text-xl">
                    라이브러리
                  </th>
                  <td className="p-2 text-left text-sm md:text-xl">
            ...
            <div className="sm:gap-6 flex flex-col gap-4 md:gap-8">
              <p className="sm:text-2xl text-xl font-bold md:text-3xl">Link</p>
              <div className="sm:gap-8 flex flex-wrap gap-6 md:gap-12">
            ...
            <div className="sm:gap-6 flex flex-col gap-4 md:gap-8">
              <p className="sm:text-2xl text-xl font-bold md:text-3xl">프로젝트 소개</p>
              <p>- 코드잇에서 진행한 프로젝트로 리스트페이지를 담당하였습니다.</p>
              <p>- 질문과 답변을 통해 마음을 열고 대화를 나누는 소통 플랫폼 입니다.</p>
              <p>
            ...
            <div className="sm:gap-6 flex flex-col gap-4 md:gap-8">
              <p className="sm:text-2xl text-xl font-bold md:text-3xl">내가 기여한 부분</p>
              <p>- 페이지네이션을 라이브러리 없이 직접 만들어서 사용하였습니다.</p>
              <p>
              ...
              <p>- 마찬가지로 filter를 이용하여 검색 기능과 정렬 기능을 구현했습니다.</p>
              <p>- 로컬스토리지를 이용하여 사용자의 정보를 확인했습니다.</p>
            </div>
          </div>
        </div>
      }
