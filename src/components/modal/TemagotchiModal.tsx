          ...
          <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-4 md:gap-8">
              ...
              <ul>
                ...
                <li>
                  &nbsp; └ 모달의 고유 id, 컴포넌트, props를 store에 저장시켜 전역적으로 선언해둔
                  modal wrapper로 모달을 띄웁니다.
                </li>
                <li>
                ...
                <li>
                  &nbsp; └ SSR로 초기 데이터를 미리 불러오고 React-Query의 prefetch를 이용하여
                  데이터들을 미리 캐싱해두는 기능을 구현하였습니다.
                </li>
                <li>
                  &nbsp; └ 게시글 상세보기 페이지에서 React-query의 onMutate를 이용하여 댓글과
                  좋아요 부분에서 옵티미스틱 UI 기능을 구현하였습니다.
                </li>
                <li>- 소셜 로그인 기능을 구현하였습니다.</li>
                <li>
                  &nbsp; └ 카카오와 구글 로그인 버튼 클릭시 지정한 URL로 리다이렉트되고 동의를 받은
                  후 서버에 인가코드를 보내 발급받은 토큰을 이용하였습니다.
                </li>
              </ul>
            </div>
          </div>
